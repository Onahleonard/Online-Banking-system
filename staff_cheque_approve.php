...
<head>
    ...
    <title>Cheque Approvals - Staff Portal</title>
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card border-0 shadow-sm rounded-4 p-4 bg-white">
                    <h1 class="h4 fw-bold text-dark mb-3">Pending Cheque Book Requests</h1>
                    <p class="text-muted small mb-4">Review and approve pending cheque book requests.</p>
                    ...
                    <form action="staff_cheque_approve_process.php" method="POST">
                            ...
                            <table class="table table-hover align-middle small">
                                ...
                                <tbody>
                                    <?php if ($result && mysql_num_rows($result) > 0): ?>
                                        ...
                                        <?php endwhile; ?>
                                    <?php else: ?>
                                        <tr><td colspan="5" class="text-center text-muted py-3">No pending cheque book requests.</td></tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <?php if ($result && mysql_num_rows($result) > 0): ?>
                            <div class="mt-3">
                                <button type="submit" name="submit_id" class="btn btn-primary rounded-pill px-4">APPROVE & ISSUE CHEQUE BOOK</button>
                            </div>
                        <?php endif; ?>
                    </form>
                </div>
